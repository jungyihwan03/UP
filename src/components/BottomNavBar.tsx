...
export default function BottomNavBar({ activeTab }: BottomNavBarProps) {
  return (
    <View style={styles.navBar}>
      ...
      <TouchableOpacity style={[styles.navItem, { marginTop: 12 }]} activeOpacity={0.6}>
        <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
...
const styles = StyleSheet.create({
  navBar: { position: 'absolute', bottom: 0, width: '100%', height: 80, backgroundColor: Colors.surface, borderTopWidth: 1, borderTopColor: '#E0E0E0', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', ...Layout.shadowNav, zIndex: 20 },
  ...
  navFabWrap: { width: 72, height: 72, alignItems: 'center', justifyContent: 'center', marginTop: -47, marginHorizontal: 6.5 },
