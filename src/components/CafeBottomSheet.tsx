        ...
        <View style={styles.cafeRow}>
          <View style={styles.cafeThumb}>
            ...
            <View style={styles.thumbBadge}>
              <Svg width="11" height="11" viewBox="0 0 24 24"><Path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" fill="#f9a825"/></Svg>
          ...
          <View style={styles.cafeInfo}>
            ...
            <View style={styles.closingTag}>
              <Svg width="13" height="13" viewBox="0 0 24 24"><Path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z" fill={Colors.error}/></Svg>
...
const styles = StyleSheet.create({
  bottomSheet: { position: 'absolute', bottom: 80, left: 0, right: 0, backgroundColor: Colors.surface, borderTopLeftRadius: Layout.radiusLg, borderTopRightRadius: Layout.radiusLg, zIndex: 15, ...Layout.shadow3 },
